...
namespace Ezfx.Csv
{
    public class CsvConfigCollection : ObservableCollection<CsvConfig>
    {
        ...
        {
            this.PropertyChanged += new PropertyChangedEventHandler(CsvConfigs_PropertyChanged);
            this.CollectionChanged += new System.Collections.Specialized.NotifyCollectionChangedEventHandler(CsvConfigs_CollectionChanged);
        }
